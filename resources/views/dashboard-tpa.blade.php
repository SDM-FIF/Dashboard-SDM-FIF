    ...
    <main class="flex-1 flex flex-col min-h-screen p-6 md:p-8 overflow-y-auto">
        ...
        <div class="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
            <div>
                ...
                <p class="text-slate-500 mt-1 text-sm md:text-base">Statistik Tenaga Pendukung Akademik berdasarkan Lokasi Kerja, Golongan, Pendidikan, dan Status Kepegawaian.</p>
            </div>
