...
<body class="flex flex-col md:flex-row bg-[#F8FAFC] min-h-screen text-[#1E293B]">
    ...
    <main class="flex-1 p-6 md:p-8 overflow-y-auto">
        ...
        {{-- Header Section --}}
        <div class="mb-8 mt-4">
            <h1 class="text-3xl md:text-4xl font-extrabold text-[#C41E3A] tracking-tight">Manajemen TPA</h1>
            <p class="text-sm text-gray-500 mt-1">Status dan ringkasan hasil import data Tenaga Kependidikan dan Profesional.</p>
        </div>
        ...
        <div class="bg-white rounded-2xl border border-gray-100 shadow-sm p-8 text-center max-w-2xl mx-auto hover:shadow-md transition-shadow">
            ...
            <p class="text-sm text-gray-500 mb-8 max-w-md mx-auto">Data Tenaga Pendukung Akademik telah berhasil diproses ke database.</p>
            ...
            <div class="flex flex-col sm:flex-row items-center justify-center gap-4">
                <a href="{{ route('manajemen-tpa.kelola-data') }}"
                    ...
                    <i class="fas fa-users mr-1"></i> Lihat Data TPA
                </a>
                ...
                <a href="{{ route('manajemen-tpa.import-data', ['step' => 1, 'reset' => 1]) }}"
                    ...
                    <i class="fas fa-redo mr-1"></i> Import Data Lagi
                </a>
            </div>
        </div>
    </main>
