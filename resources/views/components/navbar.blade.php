            ...
            <li class="relative">
                ...
                <div id="dashboardDropdown" class="hidden bg-red-700/50 backdrop-blur-sm">
                    <ul class="py-2 space-y-1">
                        ...
                        {{-- Dashboard SDM: MUNCUL UNTUK SEMUA (Guest & User) --}}
                        <li>
                        ...
                        {{-- Dashboard Dosen: HANYA UNTUK YANG PUNYA AKSES --}}
                        ...
                        {{-- Dashboard TPA: HANYA UNTUK YANG PUNYA AKSES --}}
            ...
            <div class="flex items-center space-x-3 mb-4">
                ...
                <div class="flex-1 min-w-0">
                    ...
                    <p class="text-sm font-semibold truncate">
                        {{ Auth::user()->nama_lengkap ?? Auth::user()->name ?? 'User' }}
                    </p>
