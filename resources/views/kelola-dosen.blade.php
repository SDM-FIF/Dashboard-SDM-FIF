...
@section('content')
    <div class="flex-1 p-6">
        <!-- Page Title -->
        <div class="mb-8">
            <h1 class="text-4xl font-bold text-gray-900">Kelola Data Dosen</h1>
        </div>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-8 mb-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8 mb-6">
                ...
                <!-- JFA -->
                <div>
                    <label class="block text-base font-semibold text-red-600 mb-3">JFA</label>
                    <div class="relative">
                        <select
                            class="w-full px-4 py-3 text-gray-700 bg-white border border-gray-300 rounded-lg dropdown-arrow focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-red-500 transition-all duration-200">
                            <option value="">Pilih</option>
                ...
                <!-- Kelompok Keahlian -->
                <div>
                    <label class="block text-base font-semibold text-red-600 mb-3">Kelompok Keahlian</label>
                    <div class="relative">
                        <select
                            class="w-full px-4 py-3 text-gray-700 bg-white border border-gray-300 rounded-lg dropdown-arrow focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-red-500 transition-all duration-200">
                            <option value="">Pilih</option>
