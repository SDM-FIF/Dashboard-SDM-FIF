...
<body class="flex flex-col md:flex-row bg-[#F8FAFC] min-h-screen text-[#1E293B]">
    ...
    <main class="flex-1 p-6 md:p-8 overflow-y-auto">
        ...
        <div class="mb-8 mt-4 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            <div>
                <h1 class="text-3xl md:text-4xl font-extrabold text-[#C41E3A] tracking-tight">Tambah Program Studi</h1>
                <p class="text-sm text-gray-500 mt-1 font-medium font-medium font-medium">Buat entri program studi baru beserta fakultas naungannya.</p>
            </div>
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 md:p-8 max-w-2xl hover:shadow-md transition-shadow duration-300">
            <form action="{{ route('prodi.store') }}" method="POST" class="space-y-6">
                ...
                {{-- Pilih Fakultas --}}
                <div class="flex flex-col gap-1.5">
                    <label class="text-xs font-bold text-gray-400 uppercase tracking-wider">Pilih Fakultas <span class="text-red-500">*</span></label>
