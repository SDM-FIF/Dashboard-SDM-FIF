...
<head>
    ...
    <script>
        const chartData = {
            jumlahJuara: {
                labels: @json($jumlahJuara->keys()),
                data: @json($jumlahJuara->values()),
            },
            jumlahMahasiswa: {
                labels: @json($jumlahMahasiswa->keys()),
                data: @json($jumlahMahasiswa->values()),
            },
            statusMahasiswa: {
                labels: @json($statusMahasiswa->keys()),
                data: @json($statusMahasiswa->values()),
            },
            jumlahKompetisi: {
                labels: @json($jumlahKompetisi->keys()),
                data: @json($jumlahKompetisi->values()),
            },
            jumlahKompetisi2: {
                labels: @json($jumlahKompetisi2->keys()),
                data: @json($jumlahKompetisi2->values()),
            },
        };
    </script>
