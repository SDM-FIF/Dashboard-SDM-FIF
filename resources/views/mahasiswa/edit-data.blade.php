...
<body class="flex flex-col md:flex-row bg-gray-50 font-nunito">
    ...
    <main class="flex-1 p-4 md:p-6 min-h-screen">
        ...
        <div class="mb-8">
            ...
            <p class="text-gray-600">Perbarui informasi akademik untuk mahasiswa:
                <strong>{{ $mahasiswa->nama_lengkap }}</strong></p>
        </div>
            ...
            <form action="{{ route('mahasiswa.update', $mahasiswa->id) }}" method="POST" class="space-y-8">
                ...
                <div class="pb-4">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        {{-- Action Buttons --}}
                        <div
                            class="flex flex-col md:flex-row justify-end space-y-3 md:space-y-0 md:space-x-4 border-t border-gray-200 pt-6">
    ...
    @if($errors->has('error'))
        <div id="errorNotification"
            class="fixed bottom-4 right-4 bg-red-600 text-white px-6 py-4 rounded-xl shadow-2xl z-50 flex items-center space-x-3">
