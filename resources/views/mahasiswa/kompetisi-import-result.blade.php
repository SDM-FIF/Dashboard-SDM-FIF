...
<head>
    ...
    <title>Hasil Import Mahasiswa Kompetisi - Dashboard SDM FIF</title>
...
<body class="flex flex-col md:flex-row bg-[#F8FAFC] min-h-screen text-[#1E293B]">
    ...
    <main class="flex-1 p-6 md:p-8 overflow-y-auto">
        ...
        <div class="mb-8 mt-4">
            ...
            <p class="text-sm text-gray-500 mt-1 font-medium">Status dan ringkasan hasil import partisipasi kompetisi mahasiswa ke dalam sistem database.</p>
        </div>
        ...
        <div class="bg-white rounded-2xl border border-gray-100 shadow-sm p-8 text-center max-w-2xl mx-auto hover:shadow-md transition-shadow">
            ...
            <p class="text-sm text-gray-500 mb-8 max-w-md mx-auto">Data mahasiswa kompetisi telah berhasil diproses ke database.</p>
            ...
            <div class="flex flex-col sm:flex-row items-center justify-center gap-4">
                <a href="{{ route('mahasiswa.kompetisi.index') }}"
                    ...
                    <i class="fas fa-trophy mr-1"></i> Lihat Data Kompetisi
                </a>
                
                <a href="{{ route('kompetisi.import.view', ['step' => 1, 'reset' => 1]) }}"
                    ...
                    <i class="fas fa-redo mr-1"></i> Import Data Baru
                </a>
            </div>
        </div>
    </main>
