...
@section('content')
    <div class="flex flex-col w-full bg-gray-50 min-h-screen px-8 py-10">
        <!-- Judul Halaman -->
        <h1 class="text-2xl font-semibold text-gray-800 mb-8">Import Data Dosen</h1>
        ...
        <div class="flex items-center space-x-8 mb-12">
            ...
            <div class="flex items-center space-x-3">
                <div class="flex items-center justify-center bg-[#fbb03b] w-12 h-12 rounded-2xl shadow-md">
                    <i class="fas fa-file-download text-redmain"></i>
                </div>
                <div>
        ...
        <div
            ...
            <div class="flex flex-col items-center space-y-5">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-24 w-24 text-redmain" fill="currentColor"
                ...
                <div>
                    <h2 class="text-xl font-semibold text-[#B71C1C]">Template Import Dosen</h2>
                    <p class="text-gray-500 mt-1">Klik tombol dibawah ini</p>
                </div>

                <a href="{{ route('import-file-dosen') }}"
